...
<div class="px-[24px]">
    ...
    <form action="{{url('/admin/ubah-item/'.$product->id.'/update')}}" method="post" enctype="multipart/form-data" class="mt-[32px] max-w-[1175px]">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-[32px]">
            <div>
                <label class="text-lg text-gray-3">Kategori</label>
                <input type="text" value="Item perawatan" readonly name="kategori"
