...
<div class="px-[24px]">
    ...
    <form action="{{url('/admin/tambah-layanan')}}" method="post" class="mt-[32px] max-w-[1175px]" enctype="multipart/form-data">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-[32px]">
            <div>
                <label class="text-lg text-gray-3">Kategori</label>
                <input type="text" value="Layanan" name="kategori" readonly
