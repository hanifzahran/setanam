                    ...
                    <div>
                        ...
                        <div class="flex gap-2 mt-[24px]">
                            ...
                            <div class="text-gray-3">
                                ...
                                <p class="font-lg-responsive text-grey-3">{{$product->berat}} kg</p>
                            </div>
                        </div>
                        <div class="flex gap-2 mt-[24px]">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 34 20"
                                     fill="none">
                                    <path
                            ...
                            <div class="text-gray-3">
                                ...
                                <p class="font-lg-responsive text-grey-3">{{$product->jenis_pot}}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-2 mt-[24px]">
                            ...
                            <div class="text-gray-3">
                                ...
                                <p class="font-lg-responsive text-grey-3">{{$product->intensitas_cahaya}}</p>
                            </div>
                        </div>
                        <div class="flex gap-2 mt-[24px]">
                            ...
                            <div class="text-gray-3">
                                ...
                                <p class="font-lg-responsive text-grey-3">{{$product->kebutuhan_air}}</p>
                            </div>
                        </div>
                        <div class="my-8">
                            <hr class="text-gray-4">
            ...
            const data = new Vue({
                ...
                methods: {
                    masukin() {
                        ...
                        data.append('durasi_sewa', this.durasi)
